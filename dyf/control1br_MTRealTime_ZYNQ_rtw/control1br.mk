...
MODEL           		= control1br
MODULES         		= control1br_data.c mt_modelframework.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE        		= control1br.mk
...
MASTER_ANCHOR_DIR    	= 
START_DIR          		= C:/Users/Lenovo/Desktop/br
S_FUNCTIONS     		= 
#S_FUNCTIONS     		= 
S_FUNCTIONS_LIB 		= 
SOLVER          		= 
...
MTREALTIME_ROOT		:= $(subst \,/,C:\Users\Public\modelingtech\MTRealTime\2022)
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/control1br_MTRealTime_ZYNQ_rtw \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
...
#	$(AR) -rcs "$@" $(OBJS) $(MODELREF_LINK_LIBS) $(SHARED_LIB) $(LIBS)
	$(AR) -r "$@" $(OBJS) $(MODELREF_LINK_LIBS) $(SHARED_LIB) $(LIBS)  
